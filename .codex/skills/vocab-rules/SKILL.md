...
- Resolve: MUST run `python scripts\search_similar_tags.py "CANDIDATE" 10` for each candidate and resolve ONLY from its three printed tags, types, aliases, and definitions; NEVER read [vocab/tags.json](../../../vocab/tags.json) directly.
