...
C             ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~             *                      
C         WITH 1p AND 1p X 2n QP-CONFIGURATIONS          *                      
C                  (ODD-PROTON NUCLEI)                   *                      
...
C                                                                               
      ...
      NP1=MOD(NPNUMB(1),2)                                                      
      NP2=MOD(NPNUMB(2),2)                                                      
      IF (NP1.EQ.0.AND.NP2.EQ.1) GOTO 7                                         
      WRITE(1,*) ' INCONSISTENCY IN INPUT DATA: NPNUMB(N,Z)',NPNUMB             
      NERR=NERR+1                                                               
    7 CONTINUE                                                                  
C                                                                               
      IF (NDEG.GT.NNDEG) THEN                                                   
        WRITE(1,*) ' SET NNDEG IN EO_PARA FILE TO',NDEG                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (NBCS.GT.NNBCS) THEN                                                   
        WRITE(1,*) ' SET NNBCS IN EO_PARA FILE TO',NBCS                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      MS1=MXSH(1)                                                               
      ...
      IF (JMAX.GT.NJMAX) THEN                                                   
        WRITE(1,*) ' SET NJMAX IN EO_PARA FILE TO',JMAX                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      MD=JMAX*(JMAX+1)/2                                                        
      IF (MD.GT.NMD) THEN                                                       
        WRITE(1,*) ' SET NMD IN EO_PARA FILE TO',MD                             
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      NN=NMAX(1)                                                                
...
C                                                                               
      IF (NN.GT.NNRANK) THEN                                                    
        WRITE(1,*) ' SET NNRANK IN EO_PARA FILE TO',NN                          
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (KK.GT.NKMAX) THEN                                                     
        WRITE(1,*) ' SET NKMAX IN EO_PARA FILE TO',KK                           
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (JOTMAX.GT.NJOTMX) THEN                                                
        WRITE(1,*) ' SET NJOTMX IN EO_PARA FILE TO',JOTMAX                      
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (NERR.GT.0) THEN                                                       
...
C                                                                               
  ...
  205 FORMAT(' LIMIT OF QP STATES: NMAX =',3(I4,1X),4X,                         
     1       '(2N, 1P, 2NX1P)')                                                 
  206 FORMAT(' WINDOWS TO K AND E: KMAX =',I4,1X,2(I3,'/2'),4X,                 
     1       'EMAX =',3F6.2)                                                    
...
C                                                                               
C===============================================================                
C     EO_OUT2 (WRITE 2) AND EO_OUT3 (WRITE 3) FOR XMGR GRAPHICS                 
C===============================================================                
C                                                                               
      WRITE(2,105) EGS                                                          
      DO 60 J=1,JOTMAX                                                          
...
c      DO 23 MU = -2,+2                                                         
c      IS = MU+4                                                                
c   23 SUM=SUM+AT2A(I1,IS,1)*T1AA(I2,IS,2)+T2AA(I2,IS,2)*AT1A(I1,IS,1)          
c      HM4(I1,I2,1)=-.5*AX(3)*SUM                                               
c   13 CONTINUE                                                                 
C                                                                               
C     ( AP H AN AN AP )                                                         
C                                                                               
...
c      DO 25 MU = -2,+2                                                         
c      IS = MU+4                                                                
c   25 SUM=SUM+AT2A(I1,IS,1)*AAT1(I2,IS,2)+AAT2(I2,IS,2)*AT1A(I1,IS,1)          
c      HM4(I1,I2,2)=-.5*AX(3)*SUM                                               
c   15 CONTINUE                                                                 
C                                                                               
C     ( AP AN AN H AP )                                                         
C                                                                               
...
C                                                                               
  ...
  101 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 101'                                  
      STOP                                                                      
  102 N21 = 0                                                                   
      DO 103 N1 = 1,NOQR2                                                       
      DO 103 N2 = 1,NOQR2                                                       
  ...
  103 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 103'                                  
      STOP                                                                      
  104 CONTINUE                                                                  
...
C                                                                               
  ...
  105 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 105'                                  
      STOP                                                                      
  106 N21 = 0                                                                   
      DO 107 N1 = 1,NOQR2                                                       
      DO 107 N2 = 1,NOQR2                                                       
  ...
  107 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 107'                                  
      STOP                                                                      
  108 CONTINUE                                                                  
      HMSS=HMSS-AT2A(N12,IS,IT)*AT1A(N21,IS,IT)                                 
     +         -AT2A(N21,IS,IT)*AT1A(N12,IS,IT)                                 
...
C                                                                               
C                                                                               
      SUBROUTINE ELEM01(IBET,JBET,HR00)                                         
C                                                                               
      INCLUDE 'EO_PARA'                                                         
      PARAMETER (MD2=2*NMD)                                                     
      PARAMETER (NNDEH=NNDEG/2)                                                 
...
C                                                                               
      ...
      DO 25 N2 = 1,NOQR2                                                        
      N12 = N12 + 1                                                             
      IF (IOQB(2,N1).EQ.J2.AND.IOQB(2,N2).EQ.J1) GOTO 26                        
   25 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 25'                                   
      WRITE(*,*) ' STOP: FEHLER IN ELEM01 25'                                   
      STOP                                                                      
   26 CONTINUE                                                                  
      WK1(I1,I2,JBET,IBET)=CC(J1,J2,2)                                          
      WK2(I1,I2,JBET,IBET)=CC(J1,J2,2)*HR00 + HM3(N12,2)                        
    1 CONTINUE                                                                  
C                                                                               
C     <AP H AN AN AP>                                                           
C                                                                               
      ...
      J22=ITQ(I21,2)                                                            
      J23=IOQB(2,I22)                                                           
      ANORM = AA(J21,J22,1)*CC(J1,J23,2)                                        
      SUM=ANORM*HR00                                                            
      SUM=SUM+CC(J1,J23,2)*HM1(I21,3)                                           
C                                                                               
      N12 = 0                                                                   
      DO 27 N1 = 1,NOQR2                                                        
      DO 27 N2 = 1,NOQR2                                                        
      N12 = N12 + 1                                                             
      IF (IOQB(2,N1).EQ.J23.AND.IOQB(2,N2).EQ.J1) GOTO 28                       
   27 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 27'                                   
      WRITE(*,*) ' STOP: FEHLER IN ELEM01 27'                                   
      STOP                                                                      
   28 SUM=SUM + AA(J21,J22,1)*HM3(N12,2) + HM5(I21,N12,1)                       
C                                                                               
      WK1(I1,NOQR(2)+I2,JBET,IBET)=ANORM                                        
      WK2(I1,NOQR(2)+I2,JBET,IBET)=SUM                                          
    8 CONTINUE                                                                  
C                                                                               
C     <AP AN AN H AP>                                                           
C                                                                               
      ...
      J12=ITQ(I11,2)                                                            
      J13=IOQB(2,I12)                                                           
      ANORM = BB(J12,J11,1)*CC(J13,J2,2)                                        
      SUM=ANORM*HR00                                                            
      SUM=SUM+CC(J13,J2,2)*HM1(I11,1)                                           
C                                                                               
      N12 = 0                                                                   
      DO 21 N1 = 1,NOQR2                                                        
      DO 21 N2 = 1,NOQR2                                                        
      N12 = N12 + 1                                                             
      IF (IOQB(2,N1).EQ.J2.AND.IOQB(2,N2).EQ.J13) GOTO 22                       
   21 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 21'                                   
      STOP                                                                      
   22 SUM=SUM + BB(J12,J11,1)*HM3(N12,2) + HM5(I11,N12,2)                       
C                                                                               
      WK1(NOQR(2)+I1,I2,JBET,IBET)=ANORM                                        
      WK2(NOQR(2)+I1,I2,JBET,IBET)=SUM                                          
    9 CONTINUE                                                                  
C                                                                               
C     < AP AN AN H AN AN AP >                                                   
C                                                                               
      DO 70 I1 = 1,NTQ3                                                         
      DO 70 I2 = 1,NTQ3                                                         
      I11=ITQ3(I1,1)                                                            
      ...
      J22=ITQ(I21,2)                                                            
C                                                                               
      A4N = AA(J12,J11,1)*BB(J21,J22,1)                                         
     1    + CC(J12,J22,1)*CC(J11,J21,1)                                         
     2    - CC(J12,J21,1)*CC(J11,J22,1)                                         
      ANORM=CC(J1,J2,2)*A4N                                                     
      SUM=ANORM*HR00                                                            
      SUM=SUM + CC(J1,J2,2)*BB(J12,J11,1)*HM1(I21,3)                            
     1        + CC(J1,J2,2)*AA(J21,J22,1)*HM1(I11,1)                            
     2        + CC(J1,J2,2)*HM2(I21,I11,5)                                      
C                                                                               
      N12 = 0                                                                   
      DO 75 N1 = 1,NOQR2                                                        
      DO 75 N2 = 1,NOQR2                                                        
      N12 = N12 + 1                                                             
      IF (IOQB(2,N1).EQ.J2.AND.IOQB(2,N2).EQ.J1) GOTO 76                        
   75 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 75'                                   
      STOP                                                                      
   76 CONTINUE                                                                  
      SUM=SUM + A4N*HM3(N12,2)                                                  
     1        + AA(J21,J22,1)*HM5(I11,N12,2)                                    
     2        + BB(J12,J11,1)*HM5(I21,N12,1)                                    
C                                                                               
      NOQR1 = NOQR(1)*2                                                         
      N21 = 0                                                                   
      DO 111 N1 = 1,NOQR1                                                       
      DO 111 N2 = 1,NOQR1                                                       
      N21 = N21 + 1                                                             
      IF (IOQB(1,N1).EQ.J21.AND.IOQB(1,N2).EQ.J11) GOTO 112                     
  111 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 111'                                  
      STOP                                                                      
  112 CONTINUE                                                                  
      SUM=SUM + CC(J1,J2,2)*CC(J12,J22,1)*HM3(N21,1)                            
     1        + CC(J12,J22,1)*HM6(N21,N12)                                      
C                                                                               
      N21 = 0                                                                   
      DO 113 N1 = 1,NOQR1                                                       
      DO 113 N2 = 1,NOQR1                                                       
      N21 = N21 + 1                                                             
      IF (IOQB(1,N1).EQ.J21.AND.IOQB(1,N2).EQ.J12) GOTO 114                     
  113 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 113'                                  
      STOP                                                                      
  114 CONTINUE                                                                  
      SUM=SUM - CC(J1,J2,2)*CC(J11,J22,1)*HM3(N21,1)                            
     1        - CC(J11,J22,1)*HM6(N21,N12)                                      
C                                                                               
      N21 = 0                                                                   
      DO 115 N1 = 1,NOQR1                                                       
      DO 115 N2 = 1,NOQR1                                                       
      N21 = N21 + 1                                                             
      IF (IOQB(1,N1).EQ.J22.AND.IOQB(1,N2).EQ.J12) GOTO 116                     
  115 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 115'                                  
      STOP                                                                      
  116 CONTINUE                                                                  
      SUM=SUM + CC(J1,J2,2)*CC(J11,J21,1)*HM3(N21,1)                            
     1        + CC(J11,J21,1)*HM6(N21,N12)                                      
C                                                                               
      N21 = 0                                                                   
      DO 117 N1 = 1,NOQR1                                                       
      DO 117 N2 = 1,NOQR1                                                       
      N21 = N21 + 1                                                             
      IF (IOQB(1,N1).EQ.J22.AND.IOQB(1,N2).EQ.J11) GOTO 118                     
  117 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM01 117'                                  
      STOP                                                                      
  118 CONTINUE                                                                  
      SUM=SUM - CC(J1,J2,2)*CC(J12,J21,1)*HM3(N21,1)                            
     1        - CC(J12,J21,1)*HM6(N21,N12)                                      
C                                                                               
      WK1(NOQR(2)+I1,NOQR(2)+I2,JBET,IBET) = ANORM                              
      WK2(NOQR(2)+I1,NOQR(2)+I2,JBET,IBET) = SUM                                
   70 CONTINUE                                                                  
C                                                                               
      END                                                                       
C                                                                               
...
C                                                                               
      ...
      IF (IT.EQ.2.AND.EQP1.GT.EMAX(IT)) GOTO 7                                  
      IF (IT.EQ.2.AND.IABS(KQP1).GT.KMAX(IT)) GOTO 7                            
      DO 8 I2=I1,MF(IT)                                                         
      IF (IL.GE.NMAX(IT)/2) GOTO 9                                              
      IF (I1.EQ.I2) GOTO 8                                                      
      EQP2=EQP(I2,MIXINT(IT))                                                   
      KQP2=KQN(I2,MIXINT(IT))                                                   
      IF (IT.EQ.2.AND.EQP2.GT.EMAX(IT)) GOTO 8                                  
      IF (IT.EQ.2.AND.IABS(KQP2).GT.KMAX(IT)) GOTO 8                            
      ECHK = EQP1+EQP2                                                          
      KCHK =(KQP1+KQP2)/2                                                       
      IF (IT.EQ.1.AND.ECHK.GT.EMAX(IT)) GOTO 8                                  
      IF (IT.EQ.1.AND.IABS(KCHK).GT.KMAX(IT)) GOTO 8                            
      IL = IL + 1                                                               
      ITQM(IT,IL,1)=I1                                                          
      ITQM(IT,IL,2)=I2                                                          
      ITQM(IT,IL,3)=1                                                           
...
C                                                                               
      ...
      EQP1=EQP(I1,MIXINT(IT))                                                   
      KQP1=KQN(I1,MIXINT(IT))                                                   
      IF (IT.EQ.2.AND.EQP1.GT.EMAX(IT)) GOTO 11                                 
      IF (IT.EQ.2.AND.IABS(KQP1).GT.KMAX(IT)) GOTO 11                           
      DO 12 I2=I1,MF(IT)                                                        
      IF (IL.GE.NMAX(IT)) GOTO 13                                               
      EQP2=EQP(I2,MIXINT(IT))                                                   
      KQP2=KQN(I2,MIXINT(IT))                                                   
      IF (IT.EQ.2.AND.EQP2.GT.EMAX(IT)) GOTO 12                                 
      IF (IT.EQ.2.AND.IABS(KQP2).GT.KMAX(IT)) GOTO 12                           
      ECHK = EQP1+EQP2                                                          
      KCHK =(KQP1-KQP2)/2                                                       
      IF (IT.EQ.1.AND.ECHK.GT.EMAX(IT)) GOTO 12                                 
      IF (IT.EQ.1.AND.IABS(KCHK).GT.KMAX(IT)) GOTO 12                           
      IL = IL + 1                                                               
      ITQM(IT,IL,1)=I1                                                          
      ITQM(IT,IL,2)=I2                                                          
      ITQM(IT,IL,3)=2                                                           
...
C                                                                               
      ...
      IF (N12.GT.NNATA) THEN                                                    
        WRITE(*,*) ' SET NNATA IN EO_PARA FILE TO',N12                          
        STOP                                                                    
      ENDIF                                                                     
      N12 = 0                                                                   
      DO 27 I1=1,NOQR2                                                          
...
C-------------------------------                                                
      ...
      EQP1=ETQ(I)                                                               
      KQP1=KTQ(I)                                                               
      IF (EQP1.GT.EMAX(1)) GOTO 53                                              
      IF (IABS(KQP1).GT.KMAX(1)) GOTO 53                                        
      DO 55 J=1,NOQR(2)                                                         
      IF (LI.GE.NMAX(3)/2) GOTO 54                                              
      EQP2=EQP(IOQ(2,J),MIXINT(2))                                              
      KQP2=KQN(IOQ(2,J),MIXINT(2))                                              
      IF (EQP2.GT.EMAX(2)) GOTO 55                                              
      IF (IABS(KQP2).GT.KMAX(2)) GOTO 55                                        
      ESUM = EQP1 + EQP2                                                        
      KSUM = KQP1*2 + KQP2                                                      
...
C                                                                               
      DO 63 I=1,NH                                                              
      IF (ITQ(I,3).EQ.0) GOTO 63                                                
      EQP1=ETQ(I)                                                               
      KQP1=KTQ(I)                                                               
      IF (EQP1.GT.EMAX(1)) GOTO 63                                              
      IF (IABS(KQP1).GT.KMAX(1)) GOTO 63                                        
      DO 65 J=1,NOQR(2)                                                         
      IF (LI.GE.NMAX(3)) GOTO 64                                                
      EQP2=EQP(IOQ(2,J),MIXINT(2))                                              
      KQP2=KQN(IOQ(2,J),MIXINT(2))                                              
      IF (EQP2.GT.EMAX(2)) GOTO 65                                              
      IF (IABS(KQP2).GT.KMAX(2)) GOTO 65                                        
      ESUM = EQP1 + EQP2                                                        
      KSUM = KQP1*2 - KQP2                                                      
...
C                                                                               
      IF (NTQ3.GT.NNTQ3) THEN                                                   
        WRITE(*,*) ' SET NNTQ3 IN EO_PARA FILE TO',NTQ3                         
        STOP                                                                    
      ENDIF                                                                     
C                                                                               
        IF (NRANK.EQ.0) THEN                                                    
...
C                                                                               
      IF (NRANK.GT.NNRANT) THEN                                                 
        WRITE(*,*) ' SET NNRANT IN EO_PARA FILE TO',NRANK                       
        STOP                                                                    
      ENDIF                                                                     
C                                                                               
      WRITE(1,108)                                                              
      WRITE(1,109) NRANK,NOQR(2),NTQ3                                           
      WRITE(1,*)                                                                
      WRITE(1,*) ' ----------   THE QP BASE CHOSEN:   ----------'               
      WRITE(1,*)                                                                
      II=0                                                                      
      WRITE(1,*) ' BAND  I1   I2    T     KQP    EQP : 1P STATES'               
      DO 58 I=1,NOQR(2)                                                         
      II=II+1                                                                   
      KT=KQN(IOQ(2,I),MIXINT(2))                                                
      ET=EQP(IOQ(2,I),MIXINT(2))                                                
      AKTQ3(II)=KT/2.                                                           
      ETQ3(II)=ET                                                               
      ITQM(2,I,1)=0                                                             
      ITQM(2,I,2)=I                                                             
   ...
   58 CONTINUE                                                                  
      ...
      WRITE(1,*) ' BAND  I1   I2    T     KQP    EQP : 2NX1P STATES'            
      DO 59 I=1,NTQ3                                                            
      II=II+1                                                                   
      KT=KTQ3(I)                                                                
      ET=AETQ3(I)                                                               
...
C                                                                               
  101 FORMAT(/5X,'KMAX =',I3,5X,'EMAX =',F5.2,5X,'NMAX =',I3,                   
     1        5X,'[2-QUASINEUTRON]')                                            
  102 FORMAT(/5X,'KMAX =',I3,'/2',3X,'EMAX =',F5.2,5X,'NMAX =',I3,              
     1        5X,'[1-QUASIPROTON]')                                             
