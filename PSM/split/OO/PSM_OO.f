...
C               ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~             *                    
C               WITH 1n X 1p QP-CONFIGURATIONS             *                    
C                      (ODD-ODD NUCLEI)                    *                    
C                   MUNICH, MAY '90, Y.SUN                 *                    
C                                                          *                    
...
C                                                                               
      ...
      NP1=MOD(NPNUMB(1),2)                                                      
      NP2=MOD(NPNUMB(2),2)                                                      
      IF (NP1.EQ.1.AND.NP2.EQ.1) GOTO 7                                         
      WRITE(1,*) ' INCONSISTENCY IN INPUT DATA: NPNUMB(N,Z)',NPNUMB             
      NERR=NERR+1                                                               
    7 CONTINUE                                                                  
C                                                                               
      IF (NDEG.GT.NNDEG) THEN                                                   
        WRITE(1,*) ' SET NNDEG IN OO_PARA FILE TO',NDEG                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (NBCS.GT.NNBCS) THEN                                                   
        WRITE(1,*) ' SET NNBCS IN OO_PARA FILE TO',NBCS                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      MS1=MXSH(1)                                                               
      ...
      IF (JMAX.GT.NJMAX) THEN                                                   
        WRITE(1,*) ' SET NJMAX IN OO_PARA FILE TO',JMAX                         
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      MD=JMAX*(JMAX+1)/2                                                        
      IF (MD.GT.NMD) THEN                                                       
        WRITE(1,*) ' SET NMD IN OO_PARA FILE TO',MD                             
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      NN=NMAX(1)                                                                
...
C                                                                               
      IF (NN.GT.NNRANK) THEN                                                    
        WRITE(1,*) ' SET NNRANK IN OO_PARA FILE TO',NN                          
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (KK.GT.NKMAX) THEN                                                     
        WRITE(1,*) ' SET NKMAX IN OO_PARA FILE TO',KK                           
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (JOTMAX.GT.NJOTMX) THEN                                                
        WRITE(1,*) ' SET NJOTMX IN OO_PARA FILE TO',JOTMAX                      
        NERR=NERR+1                                                             
      ENDIF                                                                     
C                                                                               
      IF (NERR.GT.0) THEN                                                       
...
C                                                                               
  ...
  202 FORMAT('                        PROTONS:',I2,' SHELLS',3I3,               
     1       '  INTRUDER',I2,' LEVELS',I3)                                      
  205 FORMAT(' LIMIT OF QP STATES: NMAX =',3(I4,1X),3X,                         
     1       '(1N, 1P, 1NX1P)')                                                 
  206 FORMAT(' WINDOWS TO K AND E: KMAX =',2(I3,'/2'),I4,4X,                    
     1       'EMAX =',3F6.2)                                                    
...
C                                                                         *     
C     FOR IA = 2 IT CALCULATES THE WAVEFUNCTIONS FOR THE A + 2 NUCLEUS    *     
C**************************************************************************     
C                                                                               
      INCLUDE 'OO_PARA'                                                         
      PARAMETER (NJMAX1=NJMAX+1)                                                
...
C                                                                               
      IF (IE.GT.NIE) THEN                                                       
       WRITE(*,*) ' SET THE PARAMETER IN GFV, NILSON, SPHSET,',                 
...
C                                                                               
C===============================================================                
C     OO_OUT2 (WRITE 2) AND OO_OUT3 (WRITE 3) FOR XMGR GRAPHICS                 
C===============================================================                
C                                                                               
      WRITE(2,105) EGS                                                          
      DO 60 J=1,JOTMAX                                                          
...
C                                                                               
  ...
  107 FORMAT('# E(I)-E(I-1) PLOT: lOWEST ENERGY =',F8.4,3X,                     
     +       'SPIN =',I3)                                                       
  108 FORMAT(//' SPIN   YRAST-E   DELTA-E',3X,'SPIN (LOWEST):',I3/              
     +         ' ~~~~   ~~~~~~~   ~~~~~~~')                                     
...
C                                                                               
      COMMON /INTRUD/ ITINT(2),NNINT(2),MIXINT(2),NLINT(2)                      
      COMMON /TINQAS/ BB(MD2,MD2,2),CC(MD2,MD2,2)                               
      COMMON /CON   / CA1(NMD,NMD,6),CA2(NMD,NMD,6),CB1(NMD,NMD,6),             
     1                CB2(NMD,NMD,6),CC1(NMD,NMD,6),CC2(NMD,NMD,6)              
C                                                                               
      DO 10 IT=1,2                                                              
...
C                                                                               
      ...
      NOQR2 = NOQR(IT)*2                                                        
C                                                                               
C     CHOOSE THE OPERATORS ACCORDING THE NUMBER II                              
C                                                                               
      IS = 0                                                                    
      DO 91 II = 0,3                                                            
      DO 91 MU = -2,2                                                           
...
C                                                                               
C                                                                               
      SUBROUTINE ELEM11(IBET,JBET,HR00)                                         
C                                                                               
      INCLUDE 'OO_PARA'                                                         
      PARAMETER (NNDEH=NNDEG/2)                                                 
      PARAMETER (MD2=2*NMD)                                                     
...
C                                                                               
      SUM = 0.D0                                                                
      ANORM=CC(JNL,JNR,1)*CC(JPL,JPR,2)                                         
      DO 1 IT = 1,2                                                             
      NOQR2 = NOQR(IT)*2                                                        
      N12 = 0                                                                   
      DO 2 N1 = 1,NOQR2                                                         
      DO 2 N2 = 1,NOQR2                                                         
      N12 = N12 + 1                                                             
      IF (IOQB(IT,N1).EQ.ITQ(IR,IT).AND.IOQB(IT,N2).EQ.ITQ(IL,IT))              
     +   GOTO 3                                                                 
    2 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM11 2'                                    
      WRITE(*,*) ' STOP: FEHLER IN ELEM11 2'                                    
      STOP                                                                      
    3 CONTINUE                                                                  
      IF (IT.EQ.1) THEN                                                         
        SUM=SUM+CC(JPL,JPR,2)*HM3(N12,1)                                        
      ELSE                                                                      
        SUM=SUM+CC(JNL,JNR,1)*HM3(N12,2)                                        
      ENDIF                                                                     
    1 CONTINUE                                                                  
C                                                                               
      NOQR1 = NOQR(1)*2                                                         
      ...
      DO 13 N2 = 1,NOQR1                                                        
      N12 = N12 + 1                                                             
      IF (IOQB(1,N1).EQ.JNL.AND.IOQB(1,N2).EQ.JNR) GOTO 14                      
   13 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM11 13'                                   
      STOP                                                                      
   14 CONTINUE                                                                  
      N34 = 0                                                                   
      DO 15 N1 = 1,NOQR2                                                        
      DO 15 N2 = 1,NOQR2                                                        
      N34 = N34 + 1                                                             
      IF (IOQB(2,N1).EQ.JPL.AND.IOQB(2,N2).EQ.JPR) GOTO 16                      
   15 CONTINUE                                                                  
      WRITE(1,*) ' STOP: FEHLER IN ELEM11 15'                                   
      STOP                                                                      
   16 CONTINUE                                                                  
      SUM=SUM+HM6(N12,N34)                                                      
C                                                                               
      WK1(IL,IR,JBET,IBET) = ANORM                                              
      WK2(IL,IR,JBET,IBET) = HR00*ANORM + SUM                                   
   70 CONTINUE                                                                  
C                                                                               
      END                                                                       
C                                                                               
...
C                                                                               
     ...
     1                NTQ,NTQH                                                  
      COMMON /TQB2  / ETQ(NNRANT),KTQ(NNRANT),ITQ(NNRANT,3),NRANK               
      COMMON /TQB3  / IOQB(2,MD2),ITQB(2,NNATA,2),NATA(2)                       
      COMMON /TQBM  / ETQM(NNRANK),KTQM(NNRANK),ITQM(NNRANK,3)                  
      COMMON /UVUV  / ESP(NMD,6),EQP(NMD,6),U(NMD,6),V(NMD,6),                  
     1                KQN(NMD,6)                                                
C                                                                               
      DIMENSION MI(2),MF(2)                                                     
...
C                                                                               
      IL = 0                                                                    
      DO 7 I1=MI(1),MF(1)                                                       
      IF (EQP(I1,MIXINT(1)).GT.EMAX(1)) GOTO 7                                  
      IF (IABS(KQN(I1,MIXINT(1))).GT.KMAX(1)) GOTO 7                            
      DO 8 I2=MI(2),MF(2)                                                       
      IF (IL.GE.NH) GOTO 9                                                      
      IF (EQP(I2,MIXINT(2)).GT.EMAX(2)) GOTO 8                                  
      IF (IABS(KQN(I2,MIXINT(2))).GT.KMAX(2)) GOTO 8                            
      ECHK = EQP(I1,MIXINT(1))+EQP(I2,MIXINT(2))                                
      KCHK = (KQN(I1,MIXINT(1))+KQN(I2,MIXINT(2)))/2                            
      IF (ECHK.GT.EMAX(3)) GOTO 8                                               
      IF (IABS(KCHK).GT.KMAX(3)) GOTO 8                                         
      IL = IL + 1                                                               
      ITQM(IL,1)=I1                                                             
      ITQM(IL,2)=I2                                                             
      ITQM(IL,3)=1                                                              
...
C                                                                               
      DO 11 I1=MI(1),MF(1)                                                      
      IF (EQP(I1,MIXINT(1)).GT.EMAX(1)) GOTO 11                                 
      IF (IABS(KQN(I1,MIXINT(1))).GT.KMAX(1)) GOTO 11                           
      DO 12 I2=MI(2),MF(2)                                                      
      IF (IL.GE.NMAX(3)) GOTO 13                                                
      IF (EQP(I2,MIXINT(2)).GT.EMAX(2)) GOTO 12                                 
      IF (IABS(KQN(I2,MIXINT(2))).GT.KMAX(2)) GOTO 12                           
      ECHK = EQP(I1,MIXINT(1))+EQP(I2,MIXINT(2))                                
      KCHK = (KQN(I1,MIXINT(1))-KQN(I2,MIXINT(2)))/2                            
      IF (ECHK.GT.EMAX(3)) GOTO 12                                              
      IF (IABS(KCHK).GT.KMAX(3)) GOTO 12                                        
      IL = IL + 1                                                               
      ITQM(IL,1)=I1                                                             
      ITQM(IL,2)=I2                                                             
      ITQM(IL,3)=2                                                              
...
C                                                                               
      ...
      DO 20 I1=1,NOQ(IT)                                                        
      DO 21 I2=1,NTQ                                                            
      IF (IOQ(IT,I1).EQ.ITQM(I2,IT)) THEN                                       
        II=II+1                                                                 
        IOQ(IT,II)=IOQ(IT,I1)                                                   
...
C                                                                               
      NOQR2=II*2                                                                
      NATA(IT)=NOQR2*NOQR2                                                      
      IF (NATA(IT).GT.NNATA) THEN                                               
        WRITE(*,*) 'SET NNATA IN OO_PARA FILE TO',NATA(IT)                      
        STOP                                                                    
      ENDIF                                                                     
C                                                                               
      N12 = 0                                                                   
...
C                                                                               
      ...
      DO 30 I1=1,NOQR(IT)                                                       
      II1=IOQ(IT,I1)                                                            
      UMV=U(II1,MIXINT(IT))**2-V(II1,MIXINT(IT))**2                             
      UV=U(II1,MIXINT(IT))*V(II1,MIXINT(IT))                                    
   30 WRITE(1,105) I1,IOQ(IT,I1),KQN(IOQ(IT,I1),MIXINT(IT)),                    
     1      EQP(IOQ(IT,I1),MIXINT(IT)),UMV,UV,                                  
     2      U(II1,MIXINT(IT)),V(II1,MIXINT(IT))                                 
C                                                                               
    6 CONTINUE                                                                  
C                                                                               
      IIN=NTQH+1                                                                
      DO 24 II = IIN,NTQ                                                        
   24 ITQM(II,2) = ITQM(II,2) + NLINT(2)                                        
C                                                                               
      WRITE(1,106) NTQ,NTQH                                                     
      DO 31 II = 1,NTQ                                                          
      I1 = ITQM(II,1)                                                           
      IF (II.LE.NTQH) THEN                                                      
        I2 = ITQM(II,2)                                                         
      ELSE                                                                      
        I2 = ITQM(II,2)-NLINT(2)                                                
      ENDIF                                                                     
C                                                                               
      UMV = U(I1,MIXINT(1))**2 - V(I1,MIXINT(1))**2                             
     1    + U(I2,MIXINT(2))**2 - V(I2,MIXINT(2))**2                             
      UV  = U(I1,MIXINT(1))*V(I1,MIXINT(1))                                     
     1     +U(I2,MIXINT(2))*V(I2,MIXINT(2))                                     
   31 WRITE(1,107) II,(ITQM(II,J),J=1,3),KTQM(II),ETQM(II),UMV,UV               
C---------------------------                                                    
C       REARANGEMENT                                                            
C---------------------------                                                    
      DO 4 I =1,NTQ                                                             
...
C                                                                               
      IF (NRANK.GT.NNRANT) THEN                                                 
        WRITE(*,*) 'SET NNRANT IN OO_PARA FILE TO',NRANK                        
        STOP                                                                    
      ENDIF                                                                     
C                                                                               
      WRITE(1,108)                                                              
      ...
      WRITE(1,*)                                                                
      WRITE(1,*) ' BAND  I1   I2    T   KQP   EQP : 1NX1P STATES'               
      DO 72 I=1,NRANK                                                           
      WRITE(1,114) I,(ITQ(I,N),N=1,3),KTQ(I),ETQ(I)                             
   72 CONTINUE                                                                  
C                                                                               
  ...
  106 FORMAT(//,' NEUTRON-PROTON BASIS:   NTQ =',I3,' STATES',                  
     1  ' (NTQH = ',I3,')',/,55('-'),/,                                         
     2  ' II   I1 I2   T   K',5X,'E',10X,'U**2-V**2',6X,'UV')                   
  107 FORMAT(I3,I5,I3,2I4,3F12.5)                                               
  108 FORMAT(/)                                                                 
  109 FORMAT(' DIMENSION OF THE CONFIG. SPACE: ',I4)                            
