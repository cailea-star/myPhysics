/**
 * @file    test_hfb_cylindrical_14.cpp
 * @author  cailea
 * @date    2026-09-02
...
#include "../hfb_cylindrical/hfb_edf_gogny.hpp"
...
int main() {
    ...
    const auto [bz_F, br_F] = CylindricalSetting::b0beta20_to_bzbr(b0_F, beta20_F);
    CylindricalSetting cylindricalsetting_(bz_F, br_F, Nshell_I, true, true);
    cylindricalsetting_.Nr_I = 50;
    cylindricalsetting_.Nz_I = 50;
    ...
    const HFBCylindricalObservableReference reference_{-1385.166912, -7.365802, -24.759824, -20.714699, -0.000000, 2.246873, -0.000000, 4.626410, 4.438686};
