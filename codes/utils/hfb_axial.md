...
This note specializes the general [Hartree–Fock–Bogoliubov Method](../utils/hfb.md) to an even-even nucleus without quasiparticle blocking.
...
Let $N_{\mathrm{sp}}$ denote the full single-particle dimension. Using the field definitions in [Hartree–Fock–Bogoliubov Method](../utils/hfb.md),
