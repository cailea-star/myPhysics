...
$$
\boxed{N_{n_r}^{\Lambda}=\sqrt{\frac{n_r!}{(n_r+\Lambda)!}},\qquad \phi_{n_r}^{\Lambda}(r_\perp)=\frac{\sqrt2}{b_{r_\perp}}N_{n_r}^{\Lambda}L_{n_r}^{(\Lambda)}(\eta)\eta^{\Lambda/2}e^{-\eta/2}.}
$$

It satisfies

$$
\int_0^\infty r_\perp\,dr_\perp\,\phi_{n_r}^{\Lambda}(r_\perp)\phi_{n_r'}^{\Lambda}(r_\perp)=\delta_{n_rn_r'}.
$$

The coordinate derivatives are

$$
\partial_{r_\perp}=\frac{2r_\perp}{b_{r_\perp}^2}\partial_\eta,\qquad \partial_{r_\perp}^2=\frac{4r_\perp^2}{b_{r_\perp}^4}\partial_\eta^2+\frac{2}{b_{r_\perp}^2}\partial_\eta.
$$
...
$$
\boxed{\partial_{r_\perp}\phi_{n_r}^{\Lambda}(r_\perp)=\frac{\sqrt2N_{n_r}^{\Lambda}}{b_{r_\perp}}\frac{2r_\perp}{b_{r_\perp}^2}\partial_\eta u_{n_r}^{\Lambda}(\eta).}
$$
...
$$
\phi_{n_z}(z)\phi_{n_z'}(z)\propto e^{-\zeta^2},\qquad \phi_{n_r}^{\Lambda}(r_\perp)\phi_{n_r'}^{\Lambda}(r_\perp)\propto e^{-\eta}.
$$
