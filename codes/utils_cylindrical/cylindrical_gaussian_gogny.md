...
These matrix elements supply the representative $\Gamma$ and $\Delta$ fields defined in [Axial HFB](../utils_hfb/hfb_kramers.md#representative-gamma-and-delta-fields).
