...
inline double HFB::update_UV_E_rho_kappa(double temperature_F, double EspCut_F) {
...
inline void HFB::search_lambda(double temperature_F, double EspCut_F, double lambdaTolerance_F) {
