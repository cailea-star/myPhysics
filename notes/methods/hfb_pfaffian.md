...
Let $N_{\mathrm{sp}}$ denote the number of single-particle states and $|0\rangle$ the particle vacuum. Use the Bogoliubov convention in [Quasiparticle Vacuum](../../codes/utils/hfb.md#quasiparticle-vacuum), with operator vectors arranged as columns:
