---
[source_json]: A._N._Andreyev_Y.2013_Phys.Rev.Lett._Vol.110Nol.242502P..json
[doi]: 10.1103/physrevlett.110.242502
[first_author]: A. N., Andreyev
[affiliations]: 
---
...
[tags]: alpha_decay, alpha_clustering
[source]: introduction.
```
...
```tags
[claim-type]: definition
[tags]: alpha_formation_probability
[source]: theoretical analysis.
```
...
```tags
[claim-type]: result
[tags]: production_cross_section, recoil_separator
[source]: experimental setup.
```
...
```tags
[claim-type]: result
[tags]: alpha_decay_energy, alpha_decay_half_life, recoil_separator
...
```tags
[claim-type]: result
[tags]: alpha_formation_probability, UDL
...
[tags]: pairing_gap, alpha_formation_probability, BCS
...
[tags]: alpha_decay, shell_closure, recoil_separator
[source]: abstract.
```
...
```tags
[claim-type]: result
[tags]: shell_closure, alpha_formation_probability, UDL
[source]: abstract.
```
...
[tags]: UDL
[source]: theoretical analysis.
[ref]: [25] C. Qi et al., Phys. Rev. Lett. 103, 072501 (2009); Phys. Rev. C 80, 044326 (2009).
...
```tags
[claim-type]: method
[tags]: UDL, R_matrix_theory, alpha_decay_half_life
[source]: theoretical analysis.
[ref]: [26] R. G. Thomas, Prog. Theor. Phys. 12, 253 (1954).
...
[tags]: alpha_formation_probability
[source]: conclusion.
[ref]: [27] C. Qi et al., Phys. Rev. C 81, 064319 (2010).
...
[tags]: pairing_gap
[source]: pairing analysis.
[ref]: [29] M. Wang et al., Chin. Phys. C 36, 1603 (2012).
...
[source]: theoretical analysis.
[ref]: [2] R. G. Lovas et al., Phys. Rep. 294, 265 (1998).
