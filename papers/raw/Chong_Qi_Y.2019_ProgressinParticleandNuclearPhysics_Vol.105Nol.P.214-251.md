---
[source_json]: Chong_Qi_Y.2019_ProgressinParticleandNuclearPhysics_Vol.105Nol.P.214-251.json
[doi]: 10.1016/j.ppnp.2018.11.003
[first_author]: Chong, Qi
[affiliations]: Department of Physics, Royal Institute of Technology (KTH), SE-10691 Stockholm, Sweden
---
...
[tags]: charged_particle_radioactivity
[source]: Abstract.
```
...
> The evaluation of the cluster formation probability is a challenging undertaking because a proper description of the cluster in terms of its components requires a microscopic framework that is highly complex.
...
```tags
[claim-type]: definition
[tags]: alpha_formation_amplitude
[source]: section 5.2.
```
...
```tags
[claim-type]: background
[tags]: alpha_decay_half_life, geiger_nuttall_law
[source]: section 5.4.
```
...
```tags
[claim-type]: definition
[tags]: experimental_to_calculated_ratio, alpha_decay_half_life
[source]: section 3.2.
```
...
```tags
[claim-type]: result
[tags]: alpha_formation_amplitude, UDL
[source]: section 5.4.1, figure 13.
```
...
```tags
[claim-type]: result
[tags]: experimental_to_calculated_ratio, alpha_decay_half_life, UDL
[source]: section 5.4.1, figure 14.
```
...
[tags]: experimental_to_calculated_ratio, alpha_decay_half_life, UDL, geiger_nuttall_law
[source]: section 5.4.2, figure 16.
```
...
```tags
[claim-type]: result
[tags]: alpha_formation_amplitude, alpha_decay_half_life, geiger_nuttall_law
[source]: section 5.4.2, figure 17.
```

> For the polonium isotopic chain with N < 126, as can be seen from Figs. 15 & 17, the linear behaviour of \(\log_{10}|RF_\alpha(R)|^2\) breaks down below \(^{196}\mathrm{Po}\). As a result, the Geiger-Nuttall law is broken in the light polonium isotopes.
...
```tags
[claim-type]: comparison
[tags]: microscopic_theory, shell_model
[source]: section 9.
```
...
[tags]: microscopic_theory
[source]: section 9.
```

> In this review we have gone through the developments that took place in this subject during the last couple of decades. We have shown that in all cases a proper explanation of the decay process requires the microscopic description which started to be formulated just at the beginning of quantum mechanics.
...
```tags
[claim-type]: background
[tags]: R_matrix_theory, microscopic_theory
[source]: section 2.
[ref]: [9] Teichmann T and Wigner E 1952 Phys. Rev. 87 123
...
```tags
[claim-type]: method
[tags]: R_matrix_theory, UDL
[source]: section 3.2.
[ref]: [40] Qi C, Delion D S, Liotta R J and Wyss R 2012 Phys. Rev. C 85 011303
[doi]: 10.1103/PhysRevC.85.011303
```

> Within the R-matrix framework, the logarithm of the decay half-life can be approximated by the so-called universal decay law (UDL) as [40]:
...
[tags]: nuclear_clusterization
[source]: section 5.5.
[ref]: [133] Qi C, Andreyev A N, Huyse M, Liotta R J, Van Duppen P and Wyss R A 2010 Phys. Rev. C 81 064319
...
```tags
[claim-type]: background
[tags]: geiger_nuttall_law, alpha_formation_amplitude
[source]: section 5.4.2.
[ref]: [166] Qi C, Andreyev A, Huyse M, Liotta R, Duppen P V and Wyss R 2014 Phys. Lett. B 734 203–206
...
- `[section]: Results | [item]: coverage | [target]: figure 3 | [reason]: explicitly taken from external reference [40]`
- `[section]: Results | [item]: coverage | [target]: figure 4 | [reason]: explicitly taken from external reference [40]`
- `[section]: Results | [item]: coverage | [target]: figure 5 | [reason]: figure data sourced from external reference [40]`
- `[section]: Results | [item]: coverage | [target]: figure 6 | [reason]: no complete result sentence with direct method tag`
- `[section]: Results | [item]: coverage | [target]: figure 7 | [reason]: explicitly taken from external reference [40]`
- `[section]: Results | [item]: coverage | [target]: figure 8 | [reason]: explicitly taken from external reference [133]`
- `[section]: Results | [item]: coverage | [target]: figure 9 | [reason]: explicitly taken from external reference [133]`
- `[section]: Results | [item]: coverage | [target]: figure 10 | [reason]: explicitly taken from external reference [133]`
- `[section]: Results | [item]: coverage | [target]: figure 11 | [reason]: caption comparison lacks complete-sentence result evidence`
- `[section]: Results | [item]: coverage | [target]: figure 12 | [reason]: explicitly taken from external reference [160]`
- `[section]: Results | [item]: coverage | [target]: figure 15 | [reason]: explicitly taken from external reference [166]`
- `[section]: Results | [item]: coverage | [target]: figure 18 | [reason]: explicitly taken from external reference [166]`
- `[section]: Results | [item]: coverage | [target]: figure 19 | [reason]: approved tag is method, not output quantity`
- `[section]: Results | [item]: coverage | [target]: figure 20 | [reason]: external figure with externally sourced added data`
- `[section]: Results | [item]: coverage | [target]: figure 21 | [reason]: explicitly taken from external reference [165]`
- `[section]: Results | [item]: coverage | [target]: figure 22 | [reason]: explicitly taken from external reference [160]`
