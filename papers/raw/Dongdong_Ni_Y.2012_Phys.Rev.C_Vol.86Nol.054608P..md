---
[source_json]: Dongdong_Ni_Y.2012_Phys.Rev.C_Vol.86Nol.054608P..json
[doi]: 10.1103/physrevc.86.054608
[first_author]: Dongdong, Ni
[affiliations]: 
---
...
```tags
[claim-type]: background
[tags]: alpha_decay_fine_structure, deformed
[source]: section I. Introduction
```
...
[tags]: alpha_decay_fine_structure, odd_mass_nuclei, coupled_channels_method
[source]: section I. Introduction
```
...
```tags
[claim-type]: background
[tags]: MCCM, coupled_channels_method
[source]: section I. Introduction
```
...
```tags
[claim-type]: definition
[tags]: alpha_decay_half_life, alpha_decay_branching_ratio
...
```tags
[claim-type]: result
[tags]: alpha_decay_half_life, MCCM
...
[tags]: alpha_decay_branching_ratio, MCCM
...
```tags
[claim-type]: result
[tags]: alpha_decay_intensity, MCCM
...
```tags
[claim-type]: comparison
[tags]: alpha_decay_branching_ratio, coupled_channels_method
[source]: section III. Numerical Results and Discussion, table III
```
...
```tags
[claim-type]: comparison
[tags]: MCCM, alpha_decay_branching_ratio, alpha_decay_half_life
[source]: abstract
```
...
[tags]: MCCM, coupled_channels_method
[source]: section I. Introduction
[ref]: [9] Dongdong Ni and Zhongzhou Ren, Phys. Rev. C 81, 064318 (2010); [10] Dongdong Ni and Zhongzhou Ren, Phys. Rev. C 83, 067302 (2011)
...
[tags]: MCCM
[source]: section II. Theoretical Framework for α Decay of Deformed Nuclei
[ref]: [10] Dongdong Ni and Zhongzhou Ren, Phys. Rev. C 83, 067302 (2011); [15] D. Ni and Z. Ren, Phys. Rev. C 80, 051303(R) (2009); 81, 024315 (2010)
...
[claim-type]: method
[tags]: alpha_decay_half_life, alpha_decay_branching_ratio
[source]: section III. Numerical Results and Discussion
[ref]: [32] NNDC, Brookhaven National Laboratory; [33] G. Audi, A. H. Wapstra, and C. Thibault, Nucl. Phys. A 729, 337 (2003)
...
[source]: section III. Numerical Results and Discussion
[ref]: [34] P. Möller, J. R. Nix, W. D. Myers, and W. J. Swiatecki, At. Data Nucl. Data Tables 59, 185 (1995)
...
```tags
[claim-type]: method
[tags]: first_order_perturbation_theory
[source]: section III. Numerical Results and Discussion
[ref]: [35] A. Bohr and B. R. Mottelson, Nuclear Structure, Vol. 1 (World Scientific, Singapore, 1998)
