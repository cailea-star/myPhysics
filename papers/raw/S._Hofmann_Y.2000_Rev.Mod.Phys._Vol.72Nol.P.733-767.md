---
[source_json]: S._Hofmann_Y.2000_Rev.Mod.Phys._Vol.72Nol.P.733-767.json
[doi]: 10.1103/revmodphys.72.733
[first_author]: S., Hofmann
[affiliations]: 
---
...
```tags
[claim-type]: background
[tags]: complete_fusion_reaction, recoil_separator, genetic_alpha_particle_correlation
[source]: section 1.
```
...
```tags
[claim-type]: method
[tags]: recoil_separator, genetic_alpha_particle_correlation
[source]: section 3.A.
```
...
```tags
[claim-type]: background
[tags]: alpha_decay_half_life, spontaneous_fission_half_life, decay_mode_branching_ratio
[source]: figure 3.
```
...
```tags
[claim-type]: result
[tags]: alpha_decay_energy, genetic_alpha_particle_correlation
...
```tags
[claim-type]: background
[tags]: fission_fragment_mass_yield, fission_fragment_total_kinetic_energy
...
```tags
[claim-type]: background
[tags]: nuclear_potential_energy_surface, fission_fragment_total_kinetic_energy
...
```tags
[claim-type]: background
[tags]: quadrupole_deformation, recoil_separator
...
```tags
[claim-type]: background
[tags]: production_cross_section, shell_correction_energy
...
```tags
[claim-type]: background
[tags]: production_cross_section, genetic_alpha_particle_correlation
...
[tags]: nuclear_binding_energy, macroscopic_microscopic_method, genetic_alpha_particle_correlation
...
```tags
[claim-type]: background
[tags]: single_particle_energy_level
...
```tags
[claim-type]: background
[tags]: shell_correction_energy, fission_barrier_height, spontaneous_fission_half_life
...
```tags
[claim-type]: background
[tags]: excitation_function, production_cross_section
...
```tags
[claim-type]: comparison
[tags]: excitation_energy, complete_fusion_reaction
...
```tags
[claim-type]: background
[tags]: single_particle_energy_level, complete_fusion_reaction
...
```tags
[claim-type]: result
[tags]: nuclear_potential_energy_surface, macroscopic_microscopic_method
...
```tags
[claim-type]: comparison
[tags]: production_cross_section, superheavy_nuclei, complete_fusion_reaction
[source]: section 7.
```
...
[tags]: excitation_energy, complete_fusion_reaction
[source]: section 6.A.
[ref]: R. Bass, Nucl. Phys. A 231, 45 (1974).
...
```tags
[claim-type]: method
[tags]: excitation_energy, nuclear_binding_energy, complete_fusion_reaction
[source]: section 4.B.
[ref]: W. D. Myers and W. J. Świątecki, Nuclear properties according to the Thomas-Fermi model, Nucl. Phys. A 601, 141–167 (1996).
...
```tags
[claim-type]: method
[tags]: recoil_separator
[source]: section 3.D.
[ref]: C. N. Davids et al., Startup of the Fragment Mass Analyzer at ATLAS, Nucl. Instrum. Methods B 70, 358–365 (1992).
...
```tags
[claim-type]: comparison
[tags]: quadrupole_deformation, macroscopic_microscopic_method
[source]: section 5.A.
[ref]: Reiter et al., Phys. Rev. Lett. 82, 509 (1999); Patyk and Sobiczewski, Nucl. Phys. A 533, 132 (1991); Möller et al., At. Data Nucl. Data Tables 59, 185 (1995); Muntian et al., Phys. Rev. C 60, 041302 (1999).
...
- `[section]: Results | [item]: coverage | [target]: figure 1 | [reason]: apparatus schematic has no current-work output quantity`
- `[section]: Results | [item]: coverage | [target]: figure 2 | [reason]: detector schematic has no current-work output quantity`
- `[section]: Results | [item]: coverage | [target]: nuclear_binding_energy | [reason]: full text provides calculated–experimental comparisons but no definition or established-background statement`
- `[section]: Results | [item]: coverage | [target]: table II | [reason]: nomenclature table lists element names and symbols but no current-work output quantity`
