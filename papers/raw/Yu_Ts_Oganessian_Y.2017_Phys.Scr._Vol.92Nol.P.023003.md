---
[source_json]: Yu_Ts_Oganessian_Y.2017_Phys.Scr._Vol.92Nol.P.023003.json
[doi]: 10.1088/1402-4896/aa53c1
[first_author]: Yu Ts, Oganessian
[affiliations]: Joint Institute for Nuclear Research, 141980 Dubna,, National University ‘Dubna’
---
...
[tags]: superheavy_nuclei, superheavy_nuclei_island_of_stability
[source]: abstract.
```
...
```tags
[claim-type]: background
[tags]: superheavy_nuclei, nuclear_shell_effect
[source]: abstract.
```
...
```tags
[claim-type]: definition
[tags]: macroscopic_microscopic_method
[source]: section 2.1.
```
...
```tags
[claim-type]: background
[tags]: shell_correction_energy, spontaneous_fission_half_life, fission_barrier_height
[source]: section 2.
```
...
```tags
[claim-type]: background
[tags]: shell_correction_energy, macroscopic_microscopic_method
...
```tags
[claim-type]: result
[tags]: shell_correction_energy, fission_barrier_height, macroscopic_microscopic_method
...
```tags
[claim-type]: result
[tags]: single_particle_energy_level, woods_saxon_potential
...
```tags
[claim-type]: background
[tags]: nuclear_potential_energy_surface
...
```tags
[claim-type]: result
[tags]: fission_barrier_height, shell_correction_energy, macroscopic_microscopic_method
...
[tags]: alpha_decay_half_life, macroscopic_microscopic_method
...
```tags
[claim-type]: background
[tags]: production_cross_section, fission_barrier_height, complete_fusion_reaction
...
```tags
[claim-type]: comparison
[tags]: alpha_decay_energy, macroscopic_microscopic_method
...
```tags
[claim-type]: result
[tags]: production_cross_section, fission_barrier_height, spontaneous_fission_half_life, complete_fusion_reaction
...
[tags]: alpha_decay_half_life, spontaneous_fission_half_life
[source]: section 2.2, figure 12.
[ref]: [20] Smolańczuk R, Skalski J and Sobiczewski A 1995 Phys. Rev. C 52 1871.
...
[tags]: alpha_decay_energy
[source]: section 2.2, figure 14.
[ref]: [22] Sobiczewski A 2015 Phys. Scr. 90 114018.
...
[tags]: alpha_decay_energy, macroscopic_microscopic_method
[source]: section 4.3.1.
[ref]: [84] Muntian I, Patyk Z and Sobiczewski A 2003 Phys. At. Nucl. 66 1015.
...
[tags]: production_cross_section, fission_barrier_height, spontaneous_fission_half_life, complete_fusion_reaction
[source]: section 4.4, figure 22.
[ref]: [115] Utyonkov V K et al 2015 Phys. Rev. C 92 034609.
