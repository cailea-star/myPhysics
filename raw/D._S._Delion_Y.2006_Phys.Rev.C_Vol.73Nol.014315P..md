---
[source_json]: D._S._Delion_Y.2006_Phys.Rev.C_Vol.73Nol.014315P..json
...
```tags
[claim-type]: background
[tags]: alpha_decay_fine_structure
[source]: section I. Introduction
```
...
[tags]: alpha_decay_fine_structure, rotational_nuclei
[source]: section I. Introduction
```
...
```tags
[claim-type]: definition
[tags]: alpha_decay_intensity, alpha_decay_width
[source]: section II.B. Resonant states
```
...
```tags
[claim-type]: result
[tags]: alpha_decay_energy, double_folding_potential
...
```tags
[claim-type]: result
[tags]: alpha_decay_width, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_energy, alpha_decay_half_life, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_half_life, alpha_decay_intensity, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_energy, alpha_decay_half_life, alpha_decay_intensity, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_half_life, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_intensity, coupled_channels_method
...
```tags
[claim-type]: result
[tags]: alpha_decay_half_life, alpha_decay_energy, coupled_channels_method
...
```tags
[claim-type]: comparison
[tags]: alpha_decay_half_life, alpha_decay_width, m3y_interaction
[source]: abstract
```
...
```tags
[claim-type]: innovation
[tags]: alpha_decay_fine_structure, alpha_clustering, m3y_interaction
[source]: section V. Conclusions
```
...
[claim-type]: background
[tags]: coupled_channels_method
[source]: section II. Stationary coupled channels formalism
[ref]: [34] D. S. Delion, A. Săndulescu, and W. Greiner, Phys. Rev. C 68, 041303(R) (2003).
...
[tags]: double_folding_potential
[source]: section II. Stationary coupled channels formalism
[ref]: [29] Dao T. Khoa, Phys. Rev. C 63, 034007 (2001).
...
[tags]: m3y_interaction
[source]: section II. Stationary coupled channels formalism
[ref]: [38] F. Cârstoíu and R. J. Lombard, Ann. Phys. (NY) 217, 279 (1992); [39] G. Bertsch, J. Borysowicz, H. McManus, and W. G. Love, Nucl. Phys. A284, 399 (1977).
...
```tags
[claim-type]: method
[tags]: excitation_energy, alpha_decay_half_life, alpha_decay_energy, quadrupole_deformation
[source]: section IV. Systematics
[ref]: [36] Y. A. Akovali, Nucl. Data Sheets 84, 1 (1998); [40] P. Möller, J. R. Nix, W. D. Myers, and W. J. Swiatecki, At. Data Nucl. Data Tables 59, 185 (1995).
